...
const Reviews = ({ product }) => {
  ...
  const review_submit = (e) => {
    ...
    dispatch(customer_review(revObj));
  };
          ...
          <div key={index} className="flex flex-col gap-1">
            <div className="flex justify-between items-center">
              <div className="flex gap-1 text-xl">
                <RatingTemp rating={rev.rating} />
              </div>
              <span className="text-slate-600">{rev.date}</span>
            </div>
            <span className="text-slate-600 text-md font-bold">{rev.name}</span>
