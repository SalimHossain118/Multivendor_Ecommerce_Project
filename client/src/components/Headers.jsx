...
const Headers = () => {
  ...
  const [categories_s, setcategories_s] = useState();
  ...
  const search = () => {
    navigate(
      `/products/search?categoryyy=${categories_s}&&value=${searchValue}`
    );
  };
    ...
    <div className="w-full bg-white">
          ...
          <div className="flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className="flex justify-start items-center gap-8">
              <li className="flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]">
                ...
                <span>mdsalimhossain</span>
              </li>
              <span>Next eCommerz</span>
            </ul>
            {/* end of ul=> */}
          ...
          <div className="h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className=" w-3/12 md-lg:w-full md-lg:pt-4 ">
              <div className="flex justify-between items-center">
                <Link to="/">
                  <img
                    className="w-[270px] h-[70px] p-1 mb-1"
                    src="http://localhost:3000/images/logo_e1.png"
                    alt="logo"
                  />
                </Link>
                <div
                  className=" bg-white justify-center items-center w-[30px] h-[30px]  text-slate-600 border border-slate-600 rounded-sm cursor-pointer lg:hidden md-lg:flex xl:hidden hidden"
                ...
                <ul className="flex justify-start items-center gap-8 text-sm font-bold uppercase md-lg:hidden">
                  <li>
                    <Link
                      to={"/"}
                      className={`p-2 block ${
                        pathname === "/" ? "text-[#ef5334]" : "text-slate-600"
                      }`}>
                      Home
                    </Link>
                  </li>
                  ...
                  <div className="flex justify-center gap-5">
                    ...
                    <div
                      ...
                      {card_products_count !== 0 && (
                        <div className="w-[18px] h-[18px] absolute bg-green-500 rounded-full text-white text-[10px] flex justify-center items-center -top-[3px] -right-[5px]">
                          {card_products_count}
                        </div>
                      )}
                    </div>
      ...
      <div className="hidden md-lg:block">
        <div
          ...
          } hidden md-lg:block w-screen h-screen bg-[rgba(0,0,0,0.5)] top-0 left-0 z-20`}></div>
        ...
        <div
          ...
          <div className="flex justify-start flex-col gap-6">
            ...
            <ul className="flex flex-col justify-start items-start  text-md font-semibold uppercase">
              ...
              <li>
                <Link
                  to={"/shops"}
                  className={`py-2 block ${
                    pathname === "/shops" ? "text-[#ef5334]" : "text-slate-600"
                  }`}>
                  Shop
                </Link>
              </li>
              <li>
                <Link
                  className={`py-2 block ${
                    pathname === "/blog" ? "text-[#ef5334]" : "text-slate-600"
                  }`}>
                  Blog
                </Link>
              </li>
              <li>
                <Link
                  className={`py-2 block ${
                    pathname === "/about" ? "text-[#ef5334]" : "text-slate-600"
                  }`}>
                  About
                </Link>
              </li>
            ...
            <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
              <div className="w-[40px] h-[40px] rounded-full flex bg-[#f5f5f5] justify-center items-center">
                <span>
                  <IoIosCall />
                </span>
              </div>
              <div className="flex justify-end flex-col gap-1">
                ...
                <span className="text-xs">support 20/30 minitius</span>
              </div>
            </div>
            <ul className="flex flex-col justify-start items-start gap-3 text-[#1c1c1c]">
              ...
              <span className="text-sm">Next eCommercz</span>
            </ul>
          </div>
        </div>
      </div>
      {/* end of sidebar for small device */}
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="relative bg-white">
              ...
              <div
                ...
                md-lg:relative absolute z-[99999]
                 bg-white w-full border-x`}>
            ...
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
              <div className="w-8/12 md-lg:w-full">
                <div className="flex border h-[50px] items-center relative gap-5">
                  <div
                    className="relative after:absolute after:h-[25px] after:w-[1px]
                        after:bg-[#afafaf] after:-right-[15px] md:hidden">
                    <select
                      onChange={(e) => setcategories_s(e.target.value)}
              ...
              <div className="w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0">
                <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
                  ...
                  <div className="flex justify-end flex-col gap-1">
                    <h2 className="text-md font-medium text-slate-700">880</h2>
                    <span className="text-sm">support 20/30 miniuts</span>
                  </div>
                </div>
              </div>
              {/* end===> */}
